...
import zti.projekt.payload.request.LoginRequest;
import zti.projekt.payload.request.RegisterRequest;
import zti.projekt.security.services.UserDetailsImpl;
import zti.projekt.payload.response.JwtResponse;
import zti.projekt.payload.response.MessageResponse;
import zti.projekt.repository.RoleRepository;
import zti.projekt.repository.UserRepository;
import zti.projekt.security.jwt.JwtUtils;
